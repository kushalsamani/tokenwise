...
---
```
{{PY}} "{{TOKENWISE}}/tokenwise/ledger.py" report --week    # default; also --today, --days N, --session <id prefix>
{{PY}} "{{TOKENWISE}}/tokenwise/ledger.py" actions --days 7 # every handler action with its estimate
```
